...
double *GetplaneT(double triangle_data[9]) {
    ...
    a = (triangle_data[4] - triangle_data[1]) * (triangle_data[8] - triangle_data[2]) - (triangle_data[7] - triangle_data[1]) * (triangle_data[5] - triangle_data[2]);
    b = (triangle_data[5] - triangle_data[2]) * (triangle_data[6] - triangle_data[0]) - (triangle_data[8] - triangle_data[2]) * (triangle_data[3] - triangle_data[0 * 9]);
    c = (triangle_data[3] - triangle_data[0]) * (triangle_data[7] - triangle_data[1]) - (triangle_data[6] - triangle_data[0]) * (triangle_data[4] - triangle_data[1]);
...
int colli(double triangle_data[9], double sphere_data[4]) {
    ...
    refvect[0] = triangle_data[0] - triangle_data[3];     // the line used for cross product AB
    ...
    refvect[0] = triangle_data[3] - triangle_data[6];     // the line used for cross product BC
    ...
    refvect[0] = triangle_data[6] - triangle_data[0];     // the line used for cross product CA
    ...
    if (flag == 1) {
        ...
        dist = dist / sqrt(line2[0] * line2[0] + line2[1] * line2[1] +
                           line2[2] * line2[2]);
        if (dist <= r) {
            colli = 1;
        }
